          ...
          <CardBody className="pt-0 pt-md-4">
            ...
            <div className="text-center">
              ...
              <div>
                ...
                Ajouter tous les class EST sidi bennour
              </div>
              <br className="my-8" />
      ...
      <Card className="bg-secondary shadow">
        <CardHeader className="bg-white border-0">
          <Row className="align-items-center">
            <Col xs="8">
              <h3 className="mb-0">Ajoute les classes </h3>
            </Col>
        ...
        <CardBody>
          <Form role="form" onSubmit={this.addClasse} >
          ...
          <div className="col">
            <Card className="bg-default shadow">
              <CardHeader className="bg-transparent border-0">
                <h3 className="text-white mb-0">Les list des classes </h3>
              </CardHeader>
              <Table className="align-items-center table-dark table-flush" responsive>
                ...
                <tbody>
                { this.state.classe.map(classe => <tr>
                  <td>{classe.id}</td><td>{classe.className}</td>
